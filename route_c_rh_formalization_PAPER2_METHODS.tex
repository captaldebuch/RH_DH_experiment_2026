...
\midrule
Query E & Forward Direction ($\text{Criterion} \implies \text{RH}$) & \textbf{$\checkmark$ PROVED} & Unconditional 4,500-line formal proof \\
...
\bottomrule
\end{tabular}
\caption{Audit outcomes of alternative route queries for $H^2$ infrastructure.}
