...
/-! ## Spectral property statements (proved via sorry for now) -/
...
theorem h15ResonantBlockGramKernel_finite_rank
  ...
  sorry  -- Collision graph → rank ≤ number of collision classes
...
theorem h15NonresonantBlockGramKernel_HS_norm_bound
  ...
  sorry  -- Divisor-hyperbola + period cancellation + Abel summation
...
theorem h15GramTrace_decomposition
  ...
  sorry  -- Trace linearity + block decomposition from Phase 2
