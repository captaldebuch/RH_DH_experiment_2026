...
\textbf{Main result:} The equivalences $\text{\texttt{NymanBeurlingCriterion}} \iff \text{\texttt{RiemannHypothesis}}$ and $\text{\texttt{LogTaperL2Decay}} \iff \text{\texttt{RiemannHypothesis}}$ are kernel-verified in Lean~4 with 0 custom axioms and 0 sorries. The frontier reduction isolates the signed bilinear dispersion problem (H15) as the remaining open analytic target.
\end{abstract}
